...
describe('AppComponent', () => {
  ...
  let isClienteSignal: ReturnType<typeof signal<boolean>>;
  let authServiceMock: Partial<AuthService>;

  beforeEach(async () => {
    isAuthSignal = signal(false);
    isClienteSignal = signal(true);
    authServiceMock = {
      ...
      isCliente: isClienteSignal as never,
  ...
  it('muestra el ícono del carrito para un Cliente autenticado', () => {
    isAuthSignal.set(true);
    isClienteSignal.set(true);
    const fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();
    const compiled = fixture.nativeElement as HTMLElement;
    expect(compiled.querySelector('[data-testid="cart-header-link"]')).toBeTruthy();
  });

  it('oculta el ícono del carrito para roles que no son Cliente', () => {
    isAuthSignal.set(true);
    isClienteSignal.set(false);
    const fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();
    const compiled = fixture.nativeElement as HTMLElement;
    expect(compiled.querySelector('[data-testid="cart-header-link"]')).toBeFalsy();
  });
