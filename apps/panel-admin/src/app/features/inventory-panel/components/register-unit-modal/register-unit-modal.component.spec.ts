...
import { RegisterUnitModalComponent } from './register-unit-modal.component';
import { InventoryService } from '../../../../core/inventory/inventory.service';
import { ToolModelOption, ToolUnit } from '../../../../core/models/inventory.models';

describe('RegisterUnitModalComponent', () => {
  let fixture: ComponentFixture<RegisterUnitModalComponent>;
  let component: RegisterUnitModalComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [RegisterUnitModalComponent],
      providers: [{ provide: InventoryService, useValue: inventorySpy }],
    });

    fixture = TestBed.createComponent(RegisterUnitModalComponent);
  ...
  it('emite created con la unidad registrada', () => {
    ...
    expect(createdSpy).toHaveBeenCalledWith(mockUnit);
  });
